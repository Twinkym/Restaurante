...
public class MesaService {
    ...
    // Obtener turnos con mesas disponibles para una fecha determinada y un número de personas
    public List<TurnoInfoDTO> obtenerTurnosInfo(LocalDate fecha, int numeroPersonas) {
        // TODO Mover a base de datos los turnos y no hardcode aqui
        // TODO incluso aunque no sea en base de datos moverlo a una const global para mandar también al front
        ...
        // Sacamos las mesas que nos valdrían en funcion del numero de personas
    ...
    // TODO se solapa solamente si es después por 90 mins
    private boolean seSolapan(LocalTime horaInicioNuevaReserva, LocalTime horaInicioReservaExistente) {
        // 89 para que no falle en las en punto
        LocalTime fin1 = horaInicioNuevaReserva.plusMinutes(89);
        LocalTime fin2 = horaInicioReservaExistente.plusMinutes(89);

        return horaInicioNuevaReserva.isBefore(fin2) && horaInicioReservaExistente.isBefore(fin1);
    }
}
